    ...
    <div class="mainwrapper">
        ...
        <div class="maincontent">
        	<div class="maincontentinner">
                ...
                <?php echo form_open_multipart('employee/insert_event' , array( 'id'=>'form2','class'=>'stdform stdform2')); ?>
               
                    	
                
                    	<p>
                        	<label>New Event Title</label>
                            <span class="field"><input type="text" name="event_title" maxlength="120" required  /></span>
                        </p>
