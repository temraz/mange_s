        ...
        <div class="maincontent" style="margin-right:0 ">
        	<div class="maincontentinner" >
                ...
                <div class="content">
                 ...
                 <?php echo form_open_multipart('edit/add_product' , array( 'id'=> "form1" , "class"=>"stdform")); ?>
                <?php if (validation_errors()){ ?>
                    	...
                    	<p>
                            ...
                            <span class="field"><input type="text" name="product_name"  /></span>
                        </p>
                        
                         <p>
                        	<label>New Product Image</label>
                            <span class="field"><input type="file" name="product_logo"  /></span>
                        </p>
                        ...
                        <p>
                            ...
                            <span class="field"><textarea cols="100" rows="5" name="product_details" class="mediuminput" ></textarea></span> 
                        </p>
