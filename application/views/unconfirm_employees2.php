                ...
                <table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head1">Sub department</th>
                    ...
                    <input type="hidden" name="emp_id" value="<?php echo $unconfirm->id ; ?>" />
                        <tr>
                            ...
                            <td  class="center">  <div class="both" >
                                                
                                                    <select name="dept"  id="search_category_id<?php echo $i;?>" required>
                            ...
                            <td class="center">
                                                ...
                                                <div id="show_sub_categories<?php echo $i;?>" align="center">
                                                <img src="<?php echo base_url(); ?>images/loader9.gif"  id="loader<?php echo $i;?>" alt="" />
                                                </div>
                                                </div>
