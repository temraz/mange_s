                ...
                <div class="widgetcontent userlistwidget">
                        ...
                        <?php echo $report->row(0)->the_reason ; ?><br />                        
                                        ...
                                        <br /> <span style="text-align:right;float:right"><?php echo $report->row(0)->report_date; ?></span>
                                         <ul class="buttonlist">
                   		                <li style="border:none;"><a href="" class="btn  btn_link"><span>Forward it to a Lawyer</span></a></li>
                                        <li><a href="<?php echo base_url(); ?>employee/chat/<?php echo  $report->row(0)->id ?>" class="btn  btn_mail"><span>Message the sender</span></a></li>
                                        </ul>
                                        <br clear="all" />
