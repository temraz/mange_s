        ...
        <div class="maincontent noright">
        	<div class="maincontentinner">
                ...
                <ul class="maintabmenu">
                	<li class="current"><a href="dashboard.html" tppabs="http://themepixels.com/themes/demo/webpage/starlight/dashboard.html">Tables</a></li>
                </ul><!--maintabmenu-->
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="center">4</td>
                            <td class="center">X</td>
                            <td class="center"><a href="tabledata.php.htm" tppabs="http://themepixels.com/themes/demo/webpage/starlight/ajax/tabledata.php" class="toggle">Quick View</a></td>
                        </tr>
                        <tr>
                            <td>Trident</td>
                            <td>Internet Explorer 5.0</td>
                ...
                <div class="contenttitle radiusbottom0">
                	<h2 class="table"><span>Table with Row Selection</span></h2>
                </div><!--contenttitle-->	
                ...
                <div class="contenttitle radiusbottom0">
                	<h2 class="table"><span>Table with Options</span></h2>
                </div><!--contenttitle-->
                ...
                <div class="contenttitle radiusbottom0">
                	<h2 class="table"><span>Dynamic Table</span></h2>
                </div><!--contenttitle-->
