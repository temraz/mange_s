    ...
    <div class="mainwrapper">
        ...
        <div class="maincontent">
        	<div class="maincontentinner">
                ...
                <div id="success"></div>
                   ...
                   <div id="report_validate">
                    ...
                    <?php if (validation_errors()){ ?>
                        ...
                        <a class="close"></a>
                        <p>The Product is published successfully </p>
                    </div>
                            <?php } ?>
                            <ul>
                ...
                <?php echo form_open_multipart('employee/insert_product' , array( 'id'=>'form2','class'=>'stdform stdform2')); ?>
               
                    	<p>
                        	<label>Product Name</label>
                            <span class="field"><input type="text" name="product_name"  maxlength="120" required/></span>
                        </p>
                        
                         <p>
                        	<label>Product Image</label>
                            <span class="field"><input type="file" name="product_logo" maxlength="500" required/></span>
                        </p>
                        
                        <p>
                        	<label>Product Date Release</label>
                            <span class="field"><input type="date" name="date_release" maxlength="20"  required/></span>
                        </p>

                        <p>
                        	<label>Product Price</label>
                            <span class="field"><input type="number" name="price" min='1'  required/>
                        ...
                        <p>
                            ...
                            <span class="field"><textarea cols="100" rows="5" name="product_details" class="mediuminput" required></textarea></span> 
                        </p>
                        
                        <br />
                        
                        <span class="stdformbutton">
                        	<button class="submit radius2">Publish</button>
                        </span>
                    </form>
