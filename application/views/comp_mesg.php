        ...
        <div class="maincontent">
        	<div class="maincontentinner">
                ...
                <div class="content">
                  ...
                  <h1 style="border-bottom:1px dashed #e1e1e1; padding-bottom:10px">Companies Messages</h1>
                <br />
                ...
                <div class="widgetcontent userlistwidget">
                        ...
                        <?php if(isset($messages)){foreach($messages as $message){?>
                            	<li>
                               <div class="avatar"><img src="<?php echo base_url(); ?>images/campanies_logo/<?php echo $message->logo ?>" width="50" height="45" /></div>
                                    <div class="info" style="margin-left:70px">
                                    	<?php echo $message->name; ?> 
                                       <br/>
                                        <span style="font-weight:bold"></span>
                                        
                        <?php echo substr($message->message,0,200).'...' ; ?><a href="<?php echo base_url(); ?>employee/comp_mesg_details/<?php echo  $message->mesg_id ?>/<?php echo  $message->id ?>">Details</a><br />
                                        
                                        
                                        <br /> <a href="<?php echo base_url(); ?>employee/comp_mesg_details/<?php echo  $message->mesg_id ?>/<?php echo  $message->id ?>" style="float:right ; color:#c1c1c1"><?php echo $message->date_m; ?></a>
                                        <br clear="all" />
                                    </div><!--info-->
                                </li>
                          <?php }}?>      
