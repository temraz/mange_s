        ...
        <div class="maincontent" style="margin-right:0 ">
        	<div class="maincontentinner" >
                ...
                <div class="content">
                	...
                	<h2 class="table"><span>Events</span></h2>
                </div><!--contenttitle-->
					...
					$pic=$row->pic;
					 ...
					 ?>
                        <tr id="<?php echo $id; ?>">
                            ...
                            <td class="center"><img src="<?php echo base_url(); ?>images/events/<?php echo $pic ; ?>"  width="60" height="50" style="border:1px solid #1c1c1c"/></td>
                            <td class="center"><?php echo $name ; ?></td>
                            <td class="center"><?php echo $date ; ?></td>
                            <td class="center"><?php echo substr($details,0,30) ; ?></td>
                            <td class="center"><a href="<?php echo base_url(); ?>company/event/<?php echo $id; ?>" >Quick View</a></td>
                        </tr>
                        <?php $counter++;}?>
                          </tbody>
                </table>
