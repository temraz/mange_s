        ...
        <div class="maincontent" style="margin-right:0 ">
        	<div class="maincontentinner" >
                ...
                <div class="content">
                 ...
                 <?php echo form_open_multipart('edit/updata_profile' , array( 'id'=> "form1" , "class"=>"stdform")); ?>
                <?php if (validation_errors()){ ?>
                        ...
                        <p>
                        	<label>What About the Company ?</label>
                            <span class="field"><textarea cols="100" rows="5" name="about_company" class="mediuminput" required></textarea></span> 
                        </p>
                        
                        <p>
                        	<label> Company Products ? </label>
                            <span class="field"><textarea cols="80" rows="5" name="about_product" class="mediuminput" required></textarea></span> 
                        </p>
                        
                       <p>
                        	<label>Links</label>
                            <span class="field"><textarea cols="80" rows="5" name="links" class="mediuminput" placeholder="You can enter multi-link with new line after every link " required></textarea></span>
                        </p>
